using KitBase, OrdinaryDiffEq, Plots, LinearAlgebra, KitBase.ProgressMeter
import FluxRC
    ...
    @inbounds Threads.@threads for i = 2:ncell-1
        for ppp1 = 1:nsp
            ...
            du[i, j, ppp1] .=
                ...
                (maxwellian(velo, conserve_prim(u[i, 1:3, ppp1], 5/3)) .- u[i, j, ppp1]) ./ vhs_collision_time(conserve_prim(u[i, 1:3, ppp1], 5/3), mu, 0.81)
