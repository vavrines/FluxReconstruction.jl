using FluxReconstruction, OrdinaryDiffEq, Plots, LinearAlgebra
using ProgressMeter: @showprogress

lagrange_point(ps.xpl, ps.xpl)
...
tspan = (0.0, 1.0)
p = (ps.ll, ps.lr, ps.dhl, ps.dhr, ps.dl, a[1], a[2])
